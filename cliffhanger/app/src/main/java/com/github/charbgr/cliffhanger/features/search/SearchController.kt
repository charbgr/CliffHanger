...
import com.github.charbgr.cliffhanger.features.search.di.DaggerSearchComponent
import com.github.charbgr.cliffhanger.features.search.di.SearchComponent
...
class SearchController : ConstraintLayout, View {
  ...
  private val component: SearchComponent by lazy {
    DaggerSearchComponent.builder().searchController(this).build()
  }
